def calc_savings_needed():
    """
    Asks what portion of the salary the person intends to save
    ...
    save enough for the down payment, which in this case is 25%.
    ...
    semi_annual_raise = 0.07  # float(input("Enter the semi annual raise as decimal: "))
